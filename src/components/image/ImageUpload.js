...
const ImageUpload = (props) => {
     ...
     return (
          <label
               className={`cursor-pointer flex items-center justify-center border border-dashed bg-[#E7ECF3] w-full min-h-[200px] rounded-lg ${className} relative overflow-hidden group`}
          >
               ...
               {!image && progress === 0 && (
                    <div className="flex flex-col items-center text-center pointer-events-none">
                         <img src="/assets/images/img-upload.png" alt="upload-img" className="max-w-[80px] mb-5" />
